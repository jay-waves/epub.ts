...
!define APP_NAME "epub.ts"
!define APP_EXE "epub.ts.exe"
!define APP_ID "epub.ts"
...
install_files:
  ...
  WriteRegStr HKLM "${UNINSTALL_KEY}" "URLInfoAbout" "https://github.com/jay-waves/epub.ts"
...
remove_files:
  ...
  DeleteRegKey /ifempty HKLM "Software\Classes\.epub"
